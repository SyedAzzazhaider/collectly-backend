  ...
  phases: [
    {
      ...
      messageTemplates: [
        {
          channel: 'email',
          subject: 'Upcoming Payment â€” Invoice #{{invoiceNumber}}',
    ...
    },
    {
      ...
      messageTemplates: [
        {
          channel: 'email',
          subject: 'Payment Due Today â€” Invoice #{{invoiceNumber}}',
    ...
    },
    {
      ...
      messageTemplates: [
        {
          channel: 'email',
          subject: 'Overdue Notice â€” Invoice #{{invoiceNumber}}',
    ...
    },
    {
      ...
      messageTemplates: [
        {
          channel: 'email',
          subject: 'Follow-up â€” Invoice #{{invoiceNumber}}',
    ...
    },
    {
      ...
      messageTemplates: [
        {
          channel: 'email',
          subject: 'Final Notice â€” Invoice #{{invoiceNumber}}',
...
describe('Security â€” Module D data isolation', () => {
